  ...
  return (
    <>
      {loading ? (
        ...
        <div className={`h-screen ${Object.keys(parPost).length === 0 ? "hidden" : "block"} w-screen relative bg-black lg:w-full`}>
...
setParPost={setParPost}                      setLoading={setLoading}
 ...
 <span>loading more post</span>
    ...
    <div className={`w-screen ${Object.keys(parPost).length === 0 ? "block" : "hidden"} h-screen`}>
