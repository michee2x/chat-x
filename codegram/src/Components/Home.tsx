...
const setToStorge = (x:string) => {
  ...
  return (
    <>
      {loading ? (
        <div className="h-screen bg-gradient-to-t from-white to-blue-900 relative w-screen gap-2 flex items-center flex-col justify-center text-gray-300 bg-black lg:w-full lg:pt-24">
                                          <span
