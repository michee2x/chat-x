...
const CommentPost = ({commentClicked,setComments, setCommentClicked, postId, setPost} : any) => {
  ...
  return (
    <div className="w-full relative h-screen bg-black">
      ...
      <div
       ...
       gap-6 h-96 border-2 border-solid cursor-pointer border-gray-600 hover:bg-gray-900"
      ...
      <div
       ...
       border border-blue-950 w-28 nounderlineb hover:bg-blue-900"
        onClick={() => {
          commentpost(text, serverFile, postId, setPost, setComments);
